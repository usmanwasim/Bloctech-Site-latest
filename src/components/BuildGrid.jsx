      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        <div className="grid gap-4 sm:gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {services.map((service) => {
            ...
            <article
              key={title}
              className="group relative rounded-2xl p-px bg-linear-to-br from-lilac/40 via-white/5 to-iris/30 transition hover:from-lilac hover:to-iris hover:-translate-y-1 duration-300"
            >
              <div className="relative h-full rounded-2xl bg-linear-to-br from-[#1b1933] to-[#0f0e1d] p-6 sm:p-7 overflow-hidden">
